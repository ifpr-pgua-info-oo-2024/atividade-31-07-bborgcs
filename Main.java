...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
       ...
       a.alunos.add(new Aluno("Maria", "iniciante", "10/12/2007"));
       a.alunos.add(new Aluno("Kauany", "avançado", "17/04/2007", "feminino", 1.57, 45.00));
       a.alunos.add(new Aluno("João", "intermediário", "16/09/1999"));
       ...
       b.alunos.add(new Aluno("Clara", "iniciante", "30/07/1987"));
       b.alunos.add(new Aluno("Marcela", "avançado", "17/05/2000", "feminino", 1.57, 45.00));
       b.alunos.add(new Aluno("Paulo", "intermediário", "11/11/2011"));
